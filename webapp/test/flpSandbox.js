		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OData V4",
									"targetURL": "#sapuicoretutorialodatav4-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapuicoretutorialodatav4-display": {
								"semanticObject": "sapuicoretutorialodatav4",
								"action": "display",
								"description": "Sample: OData V4 - Steps",
								"title": "OData V4",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.ui.core.tutorial.odatav4",
									"url": sap.ui.require.toUrl("sap/ui/core/tutorial/odatav4")
								}
							}
						}
					}
